...
public class laporanKeuangan extends javax.swing.JPanel {
    //Declare Controller untuk tampilan menu Laporan Keuangan
    ...
    public laporanKeuangan() {
        ...
        //Mengatur teks isi sel pada JTable agar berada di tengah (center)
        jTable1.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
                    boolean hasFocus, int row, int column) {
                JLabel label = (JLabel) super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
                label.setHorizontalAlignment(SwingConstants.CENTER); //Membuat teks berada di tengah
                return label;
            }
        });

        //Mengatur tampilan header (judul kolom) JTable
        jTable1.getTableHeader().setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                label.setBackground(new Color(159, 2, 2));  //Warna latar belakang header merah
                label.setForeground(new Color(237, 219, 195)); //Warna teks header cream
                label.setHorizontalAlignment(JLabel.CENTER); //Teks header di tengah
                label.setFont(label.getFont().deriveFont(Font.BOLD)); //Teks header font tebal
                label.setOpaque(true);                           //Supaya warna background muncul
                return label;
            }
        });
